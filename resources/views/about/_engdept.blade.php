...
<div style="background:var(--off-white);padding:48px 32px 0;display:flex;flex-direction:column;align-items:center;text-align:center">
  <div style="width:110px;height:110px;border-radius:50%;background:var(--white);border:2px solid rgba(212,160,23,.3);display:flex;align-items:center;justify-content:center;box-shadow:0 4px 20px rgba(0,0,0,.07);margin-bottom:14px">
    <img src="{{ asset('images/logoengdept.png') }}" alt="English Department POLBAN Logo" style="width:76%;height:76%;object-fit:contain"/>
  </div>
  <p style="font-size:.68rem;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:var(--gold);margin-bottom:6px">About the Department</p>
  <h1 style="font-size:clamp(1.4rem,3vw,2rem);font-weight:700;color:var(--dark);line-height:1.2;margin-bottom:0">English Department, Politeknik Negeri Bandung</h1>
</div>
...
<section style="padding:64px 0;background:var(--off-white)">
  <div class="container reveal">
    ...
    <div style="max-width:800px;margin:0 auto;font-size:.93rem;color:#3a3a3a;line-height:1.9">
      ...
      <h3 style="font-size:1rem;font-weight:700;color:var(--dark);margin:28px 0 12px">Study Programs</h3>
...
{{-- LINKS --}}
<section style="padding:40px 0 64px;background:var(--white)">
  <div class="container reveal" style="text-align:center">
    <h2 class="sec-heading" style="margin-bottom:20px"><span class="underline">Learn More</span></h2>
    <p style="font-size:.88rem;color:var(--gray);margin-bottom:24px">Visit the official website or follow the department on Instagram for the latest news and updates.</p>
    <div style="display:flex;gap:14px;justify-content:center;flex-wrap:wrap">
      <a href="https://bahasainggris.polban.ac.id/id/" target="_blank"
      ...
      <a href="https://instagram.com/englishdeptofficial" target="_blank"
         style="display:inline-flex;align-items:center;gap:6px;padding:10px 22px;background:var(--white);color:var(--dark);font-weight:700;font-size:.84rem;border-radius:var(--radius);border:2px solid var(--dark);box-shadow:3px 3px 0 var(--dark);text-decoration:none">
        📸 @englishdeptofficial
      </a>
    </div>
  </div>
